...
$(document).ready(function(){
	...
	$("#dv5").css("background-color","#CCCCCC");
});
</script>
...
<body>
	...
	<div class="companycontainer">
		...
		<div style="height:100%; overflow: auto;" class="menu1">
			<div class="menuhead">
			</div>
			...
			<div class="lable-line">
				...
				<span class="lable-span">
					<button class="lable">标签名</button><button class="lable-delete">删除</button>
				</span>
					<%
					}
				}
			...
			<div class="lable-add-line">
				<form>
					<span class="lable-span">
						<input type="text" class="lable-input"/><button type="submit" class="lable-add">添加</button>
					</span>
				</form>
			</div>
		</div>
